...
public class DictionaryGui extends JFrame
{
	...
	public DictionaryGui()
	{
		...
		try {
			Image searchImage = ImageIO.read(new File("src/schwimmer/dictionary/magnifying-glass.png"));
	...
	{
		Dictionary dd = new Dictionary("src/schwimmer/dictionary/dictionary.txt");
